...
exports = module.exports = class TradingViewAPI {
        ...
        this.ws.on('message', function(data)
        {
            ...
            packets.forEach(function(packet) {
                ...
                )
                {
                    ...
                    if(new Date() - self.ticker_data[ticker_name].last_retrieved > 1000 * 10)
                    {
                        self._unregisterTicker(ticker_name);
                        delete self.ticker_data[ticker_name];
                    }
                }
    ...
    {
        console.log("registering ticker " + ticker);
    ...
    {
        console.log("unregistering ticker " + ticker);
        this.ws.send(SIO.createMessage(
